  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        <h1><a href="index.html"><img src="encabezadoimg/1.png" /></a></h1>
      </div>
      ...
      <div class="usuario">
        <a href="PHP/Productos.php"  class="carrito"><i class="bi bi-cart"></i></a>
        <a href="login_usuario.html"  class="perfil"><i class="bi bi-person-circle"></i></a>
      </div>
...
<section id="Inicio" class="Inicio section-bg">
  ...
  $quantity = intval($idm[0]);
    while($i <= $quantity){
      ...
      $idv = $idv -> fetch_array();
      $valida = intval($idv[0]);
      $promov=mysqli_query($link, "Select id from p_articulos where categoria='promo'");
      $promov = $promov -> fetch_array();
      $promovalida = intval($idv[0]);
    if(($i==$valida)&&($promovalida=="promo")){
      $result=mysqli_query($link, "Select * from p_articulos where id='$id'" );
      $row = mysqli_fetch_array($result);
  ?>
  <div class="carousel-item">
        <img src="Productos/<?php echo $row["imagen"]; ?>" class="d-block w-100" width="200" height="500">
  </div>
  ...
  <table align="center">
    ...
    <tr>
        <td >
          <img src="IndexImagenes/aca.JPG" width="300">
        </td>
        <td >
          <img src="IndexImagenes/NATA top cream.JPG" width="300">
        </td>
        <td>
          <img src="IndexImagenes/crema batida.JPG" width="300" >
        </td>
    </tr>
  <tr>
      <td colspan="3" align="center">
  ...
  <br><br><table align="center">
    <tr>
      <td><img src="nuestrahistoria_img/valores.png" /></td>
      <td><img src="nuestrahistoria_img/vision.png" /></td>
      <td><img src="nuestrahistoria_img/mision.png" /></td>
    </tr>
</table>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-3 pdo-btn-container text-center">
            <a class="pdo-btn align-middle" href="#">Ir a la tienda</a>
          </div>
        </div>
    ...
    <section id="sucursales" class="sucursales ">
      <div class="container">
        ...
        <table align="center" width="80%">
          ...
          <tr>
          <td>
              <img src="SucursalesImagenes/central.png" width="840" >
          </td>
          <td>
      ...
      <tr>
          <td>
              <img src="SucursalesImagenes/cuerna.png" width="840" >
          </td>
          <td>
