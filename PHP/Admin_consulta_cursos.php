...
<tbody>
            <?php $busqueda=mysqli_query($conex,"SELECT * FROM p_registro_cursos "); 
            ...
            <div class="container_card">
                <?php while ($resultado = mysqli_fetch_assoc($busqueda)){
                 ?>
<tr class="tu">
<th scope="row" style="vertical-align: middle;"><?php echo $resultado["fecha_hora"]; ?></th>
<td style="vertical-align: middle;"><?php echo $resultado["cne_id"]; ?></td>
<td style="vertical-align: middle;"><?php echo $resultado["cro_id"]; ?></td>
</tr>    
