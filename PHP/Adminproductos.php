...
<th scope="col">#AMO_ID</th>
<th> <a href="nuevo_articulo.php"> <button type="button" class="btn btn-primary">Nuevo Articulo</button></a></th>
  <th> <a href="cerrarsesion.php">Cerrrar Sesion 
</tr>
</thead>
<tbody>
            <?php $busqueda=mysqli_query($conex,"SELECT * FROM p_articulos "); 
...
<td><img src="../Productos/<?php echo $resultado["imagen"];?>" width="100" ></td>
...
<td style="vertical-align: middle;"><?php echo $resultado["peso"]; ?></td>
<td style="vertical-align: middle;"><?php echo $resultado["unidades_disponibles"]; ?></td>
<td style="vertical-align: middle;"><?php echo $resultado["precio"]; ?></td>
<td style="vertical-align: middle;"><?php echo $resultado["amo_id"]; ?></td>
<td style="vertical-align: middle;"><a href="modificar_articulo.php?id=<?php echo $resultado["id"]; ?>"><button type='button' class='btn btn-success'>Modificar</button></a></td>
<td style="vertical-align: middle;"><a href="eliminar_articulo.php?id=<?php echo $resultado["id"]; ?>"><button type='button' class='btn btn-danger' onclick="return Borrar()">Eliminar</button></i></a></td>
</tr>    
